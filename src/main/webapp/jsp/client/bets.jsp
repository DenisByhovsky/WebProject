    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="menu">
            <ul class="list">
                ...
                <li>
                    <a href="${pageContext.request.contextPath}/jsp/client/sports.jsp">
                ...
                <li>
                    <a href="${pageContext.request.contextPath}/jsp/client/cybersports.jsp">
                        <i class="material-icons">list</i>
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-orange hover-expand-effect">
                    ...
                    <div class="content">
                        <div class="text">INVOICE<br>STATUS</div>
                        ...
                        <ul class="dashboard-stat-list">
                            ...
                            <li>
                                <form role="form" method="post" action="/controller">
                                    ...
                                    <select class="invoice-info-select" name="betType">
                                        <option value="all">Status all</option>
                                        <option value="win">win</option>
                                        <option value="lose">lose</option>
                                    </select>
                                    <input type="submit" class="b21tn" id="invoice-info-btn" value="Show">
                                </form>
                            </li>
        ...
        <div class="row clearfix">
            ...
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                <div class="card">
                    ...
                    <div class="body">
                        <div class="table-responsive" id="table-responsive" hidden>
                            <table class="table table-hover dashboard-task-infos">
                                ...
                                <tr>
                                    ...
                                    <th><fmt:message key="bl.amount"/>
                                    </th>
                                </tr>
                                </thead>
                                <c:forEach var="bet" items="${bets}">
                                    <script>
                                            document.getElementById("table-responsive").classList.add("show");</script>
                                    ...
                                    <tr>
                                        ...
                                        <td><fmt:message key="bl.type"/></td>
                                        <td><fmt:message key="bl.amount"/> ${account.invoice.currency}</td>
