    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                <div class="card">
                    <div class="body bg-cyan">
                        <div class="m-b--35 font-bold"><fmt:message key="cl.sports"/></div>
                            ...
                            <li>
                                <c:if test="${newBet.event.eventType eq 'sport'}">
                                    <div class="type">
                                        ...
                                        <div class="volley">
                                            <a href="/controller?command=event&event_type=sport&kindOfSport=volley">
                                ...
                                <c:if test="${newBet.event.eventType eq 'cybersport'}">
                                    <div class="type">
                                        <div class="dota">
                                            <a href="/controller?command=event&event_type=cybersport&kindOfSport=dota">
                                                <img src="${pageContext.request.contextPath}/images/dota.png" alt="dota" width="30px"  class="icon">
                                                <div class="value">dota</div>
                                            </a>
                                        </div>
                                        <div class="cs">
                                            <a href="/controller?command=event&event_type=cybersport&kindOfSport=cs">
                                                <img src="${pageContext.request.contextPath}/images/cs.png" alt="cs" class="icon" width="30px" >
                        ...
                        <ul class="dashboard-stat-list">
                            ...
                            <li>
                                ...
                                <div class="sport-info-client" id="betting">
                                    <h1>INFO</h1>
                                    <h4 id="green">SUCCESS</h4>
                                    <label>status:</label>
                                    <span><fmt:formatNumber value="${account.invoice.ballance}"/> ${account.invoice.currency}</span><br>
                                    <label>description:</label><span>${newBet.event.description}</span><br>
                                    <label>match:</label><span>${newBet.event.firstCompetitor} - ${newBet.event.secondCompetitor}</span><br>
            ...
            <fmt:formatDate value="${newBet.event.startTime}" type="time" timeStyle="SHORT"/>
                                    ...
                                    <label>type:</label><span>${newBet.typeBet}</span><br>
                                    <label>coef:</label><span id="coeff">${newBet.coefficient}</span><br>
                                    <label>bet: </label>
                                    <span>
                                        ${newBet.amountCount}
                                    </span><br>
                                    <label>expected:</label><span id="expected-win">${newBet.expectedWin}</span><br>
                                    </form>
                                </div>
                            </li>
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                <div class="card">
                    <div class="body bg-cyan">
                        <div class="m-b--35 font-bold">Your invoice</div>

                        <ul class="dashboard-stat-list">
                            <hr>
                            <li><div class="rt"></div>
                                <div class="bets-block">
                                    <div class="no-bets-block" hidden><p>Nothing</p></div>
                ...
                <fmt:formatDate value="${bet.event.startTime}" type="time" timeStyle="SHORT"/>
                                           ...
                                           <span>${bet.expectedWin}  ${account.invoice.currency}</span>
                                            <span class="span-coef">${bet.coefficient}</span>
