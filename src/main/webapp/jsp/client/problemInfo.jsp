                            ...
                            <li>
                                <div class="deposit-info">
                                    <div class="dep-header">
                                        <div class="pay-syst">drawback</div>
                                        <div class="proc-time"><fmt:message key="bl.time"/>
                                        </div>
                                        <div class="amount"><fmt:message key="bl.amount"/>
                                        </div>
                                        <div class="dep"></div><fmt:message key="bl.fail"/>
                                    ...
                                    <div class="dep-body" id="mastercard">
                                        ...
                                        <div class="commission">Matercard</div>
                                        <form method="get" action="/controller">
                                            <input type="hidden" name="command" value="transaction"/>
                            ...
                            <li>
                                <div class="infoDialog">
                                    ...
                                    <div class="status_value">
                                        <h1>Fail </h1>
                                        <h3>Info </h3>
                                        <div class="invoice-status" id="success"><fmt:message key="bl.status"/>
                                            :
                                            <span><fmt:formatNumber value="${account.invoice.ballance}"/> ${account.invoice.currency}</span>
                                        </div>
                                        <a href="${pageContext.request.contextPath}/jsp/client/cashOut.jsp.jsp">
                ...
                <div class="card">
                    <div class="body bg-cyan">
                        ...
                        <ul class="dashboard-stat-list">
                            <hr>
                            <li>
                                Total :  <fmt:formatNumber value="${account.invoice.ballance}"/>  ${account.invoice.currency}
