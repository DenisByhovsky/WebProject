...
<nav class="navbar">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="${pageContext.request.contextPath}/index.html">PARIROOM - BOOMAKER CLUB</a>
        </div>
        ...
        <div class="row clearfix">
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                ...
                <fmt:formatDate value="${bet.event.startTime}" type="time" timeStyle="SHORT"/>
                                            ...
                                            <label class="label-money"><img src="${pageContext.request.contextPath}/images/money.png" width="30px"></label><span>${bet.expectedWin}  ${account.invoice.currency}</span>
...
<c:forEach var="actEvent" items="${actionEvents}">
    <script> document.getElementById("info-text").classList.add("hidden");</script>
                                <thead>

                                <tr>
                                    <td class="thead-icon"><img src="images/${actEvent.kindOfSport}.png" alt="img" width="30px"></td>
                                    <td class="match-name" colspan="8">${actEvent.description}</td>
    ...
    <tbody class="tbody">
    <c:forEach var="event" items="${actEvent.events}">
        <tr>
