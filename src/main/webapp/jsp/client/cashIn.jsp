                            ...
                            <li>
                                <div class="deposit-info">
                                    ...
                                    <div class="dep-body" id="webmoney">
                                        ...
                                        <div class="proc-time">WEBMONEY</div>
                                        <form method="get" action="/controller">
                                            ...
                                            <div class="dep">
                                                <input type="submit" class="btEn" id="deSDtn" value=Deposit>
                                            </div>
                                        </form>
                                    </div>
                                    ...
                                    <div class="dep-body" id="mastercard">
                                        ...
                                        <div class="proc-time">MASTERCARD</div>
                                        <form method="get" action="/controller">
                                            <input type="hidden" name="command" value="transaction"/>
                                            ...
                                            <div class="dep">
                                                ...
                                                <input type="submit" class="btWn" id="deCDtn" value=Deposit>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="dep-body" id="visa">
                                        <div class="proc-time">VISA</div>
                                        <form method="get" action="/controller">
                                            <input type="hidden" name="command" value="transaction"/>
                                            ...
                                            <div class="dep">
                                                ...
                                                <input type="submit" class="bTtn" id="deVtn" value=Deposit>
                                            </div>
                                        </form>
                                    </div>
                                    <fmt:message key="dep.yball"/>
                                    : ${account.invoice.ballance} ${account.invoice.currency}
                                </div>
                            </li>
