            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                <div class="card">
                    <div class="body bg-teal">
                        <div class="font-bold m-b--35"><fmt:message key="inv.oper"/>
                        </div>
                            ...
                            <div class="deposit-info">
                                ...
                                <div class="dep-body" id="webmoney">
                                    ...
                                    <form method="get" action="/controller">
                                        ...
                                        <div class="dep">
                                            <input type="submit" class="btn1" id="deHGtn" value="Withdraw">
                                        </div>
                                    </form>
                                </div>
                                ...
                                <div class="dep-body" id="mastercard">
                                    ...
                                    <form method="get" action="/controller">
                                        ...
                                        <div class="dep">
                                            <input type="submit" class="bt4n" id="deGFtn" value="Drawback">
                                        </div>
                                    </form>
                                </div>
                                <div class="dep-body" id="visa">
                                    ...
                                    <form method="get" action="/controller">
                                        ...
                                        <div class="dep">
                                            ...
                                            <input type="submit" class="b2tn" id="depHGFtn" value="Drawback">
                                        </div>
                                    </form>
                                </div>
                            </div>
