        ...
        <div class="row clearfix">
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-pink hover-expand-effect">
                    <a class="icon" href="${pageContext.request.contextPath}/jsp/admin/addEvent.jsp.jsp">
                        <i class="material-icons">playlist_add_check</i>
                    </a>
                    <div class="content">
                        <div class="text">ADD MATCH</div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-cyan hover-expand-effect">
                    <a class="icon" href="/controller?command=put_result_page">
                        <i class="material-icons">playlist_add_check</i>
                    </a>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-light-green hover-expand-effect">
                    <a class="icon" href="${pageContext.request.contextPath}/jsp/admin/addEvent.jsp">
                        <i class="material-icons">playlist_add_check</i>
                    </a>
                    <div class="content">
                        <div class="text">RESULTS MATCHES</div>
                        <div class="number count-to" data-from="0" data-to="243" data-speed="1000" data-fresh-interval="20"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                <div class="card">
                    <div class="body bg-pink">
                        <div class="font-bold m-b--35"><fmt:message key="sp.cybevent"/></div>
                            ...
                            <li>
                                <form role="form" method="post" action="/controller" id="addCyber">
                                    ...
                                    <input type="hidden" name="event_type" value="cybersport">
                                        ...
                                        <select class="rt" name="kindOfSport" required>
                                            <option value="dota" selected>dota</option>
                                            <option value="wot">wot</option>
                                            <option value="cs">cs</option>
                                        </select><br>
                                    <p><fmt:message key="bl.descr"/>
                                    </p>
                                    <input id="description" type="text" name="description"  required autocomplete="off"><br>
                                    <p><fmt:message key="first.comp"/>
                                    </p>
                                    <input type="text" name="first_competitor"  required autocomplete="off"><br>        <p><fmt:message key="second.comp"/></p>
                                    <input type="text" name="second_competitor"  required autocomplete="off"><br> <p><fmt:message key="bl.date"/>

                                </p>
                                    <input type="date" name="date" required id="matchDate">
                                    <br>

                                    <p><fmt:message key="bl.time"/>
                                    </p>
                                    <input type="time" name="time" required id="matchTime">
                                    <br>
                                    <div class="add-img">
                                        <input type="submit" value="add" id="second">
                                    </div>
                                </form>
                            </li>
                        </ul>
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                <div class="card">
                    <div class="body bg-teal">
                        <div class="font-bold m-b--35"><fmt:message key="sp.event"/>
                        </div>
                        <ul class="dashboard-stat-list">
                         <li>
                        <form role="form" method="post" action="/controller" id="add">
                            ...
                            <input id="description" type="text" name="description"  required autocomplete="off"><br>   <p><fmt:message key="first.comp"/>
                        </p>
                            <input type="text" name="first_competitor"  required autocomplete="off"><br>
                            <p><fmt:message key="second.comp"/></p>

                            <input type="text" name="second_competitor"  required autocomplete="off"><br>    <p><fmt:message key="bl.date"/>

                        </p>
                            <input id="matchDate" name="date" type="date" required><br>
                            <p><fmt:message key="bl.time"/>
                            </p>
                            <input type="time" name="time" id="matchTime" required><br>
                            <div class="add-img">
