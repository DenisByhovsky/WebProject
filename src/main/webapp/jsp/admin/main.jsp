...
<c:forEach var="actionEvent" items="${actionEvents}">
    ...
    <td class="match-name" colspan="8">${actionEvent.description}</td>
                                </tr>
                                </thead>
                                <tbody>
                                <c:forEach var="event" items="${actionEvent.events}">
                                    <tr>
                                        ...
                                        <td class="coef">${event.coefficient.winFirst}</td>
                                        <td class="coef">${event.coefficient.nobody}</td>
                                        <td class="coef">${event.coefficient.winSecond}</td>
                                        <td class="coef">${event.coefficient.firstOrNobody}</td>
                                        <td class="coef">${event.coefficient.firstOrSecond}</td>
                                        <td class="coef">${event.coefficient.secondOrNobody}</td>
                                    </tr>
                                </c:forEach>
                                </tbody>
